...
function goToMobileApp() {
    ...
    if (flag) {
        ...
        if (loader.style.display == "none") {
            loaderHeader.style.display = "block";
        ...
        if (check) {
            ...
            xhr.open("POST", "http://localhost:8080/payment", true);
            ...
            setTimeout(
                ...
                xhr.onloadend = function () {
                    ...
                    if (this.status == 200) {
                        ...
                        loaderHeader.style.color = "GREEN";
                        loaderHeader.innerText = "Payment Successful!" + "\n" + data.body.message;
                        checkout.hidden = false;
                        checkout.innerText = "New Payment";
                        // we get the returned data
                    } else if (this.status == 400 || this.status == 500) {
                        let seconds = 3;
                        loaderHeader.style.color = "RED";
                        loaderHeader.innerText = "Oops...Something went wrong!" + "\n" + "Page will refresh in " + seconds + " seconds...";
